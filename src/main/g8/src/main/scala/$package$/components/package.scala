...
package object components {
  ...
  val root = TabNavigator(
    ...
    registerTabScreen[HomeScreen](navigationOptions = NavigationTabScreenOptions(tabBarIcon = (iconOptions: IconOptions) => {
      Ionicons(
        name =
      ...
      tabBarLabel = "Home")),
    registerTabScreen[SettingsScreen](navigationOptions = NavigationTabScreenOptions(    tabBarIcon = (iconOptions: IconOptions) => {
      Ionicons(
        name =
    ...
    registerTabScreen[ChatScreen](navigationOptions = NavigationTabScreenOptions(tabBarIcon = (iconOptions: IconOptions) => {
      Ionicons(
        name =
      ...
      tabBarLabel = "Chat")),
    registerTabScreen[PeopleScreen](navigationOptions = NavigationTabScreenOptions(tabBarIcon = (iconOptions: IconOptions) => {
      Ionicons(
        name =
